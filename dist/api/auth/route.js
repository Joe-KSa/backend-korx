...
import { users, accounts, roles, members, sessions, bans, images, memberImages, sounds, memberSounds, } from "../../db/schema.js";
...
authRouter.get("/auth/discord/callback", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (userSessions.length >= maxSessions) {
            ...
            yield db.delete(sessions).where(eq(sessions.id, sessionToDelete.id));
        }
        ...
        if (!existingMember.length) {
            ...
            if (newMember) {
                if (avatar) {
                    ...
                    yield db.insert(memberImages).values({
